...
public class NodeAction<T extends BaseResponse> extends Creator<ActionResponse> {
  ...
  public NodeAction(final String phloId, final NodeType nodeType, final String nodeId, final String triggerSource,
